...
### Compare 3 models using different set of input variables. Use different number of variables.Explain your choice of variables (3 sentences). Write 2 sentences explaining which model is best.
